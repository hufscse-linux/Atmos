...
SWIFT_CLASS("_TtC5Atmos11AppDelegate")
...
SWIFT_CLASS("_TtC5Atmos17LocationTableCell")
...
SWIFT_CLASS("_TtC5Atmos16StationTableCell")
@interface StationTableCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified stationName;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified sido;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified CAI;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified CAIgrade;
- (IBAction)unwindToHome:(UIStoryboardSegue * _Nonnull)segue;
- (void)viewDidLoad;
